...
//	Update the view for transitions, get the transition matrix's values 
//	in current position (tXCount, tYCount) with heading tHCount,
//	for every square & heading in the transition grid
